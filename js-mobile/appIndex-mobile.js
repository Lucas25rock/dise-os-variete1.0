...
document.addEventListener('DOMContentLoaded', function(event){
    if (username){
        document.getElementById('nombre-usuario-footer').textContent = username;
        document.getElementById('boton-usuario-footer').addEventListener("click", function(event){
            event.preventDefault();
            //logged
            window.location.href = "./pages/user/logged.html?mail=" + username;
        });
        document.getElementById('boton-carrito-footer').addEventListener("click", function(event){
            event.preventDefault();
            //
        ...
        document.getElementById('boton-about-footer').addEventListener("click", function(event){
            event.preventDefault();
